...
st.write('Enter a French sentence below and click the button to analyze its difficulty. Note that if the sentence is not in French, the difficulty prediction will not be accurate.')
